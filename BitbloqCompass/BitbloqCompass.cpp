 ...
 *   testConnection
 * \par Description
 *   Identify the device whether is the Compass.
 * \param[in]
 *   None
 * \par Output
 *   None
 ...
 *   The sensor value is a 16 bits signed integer.
 */
int16_t Compass::getHeadingY(void)
{
  int8_t return_value = 0;
  deviceCalibration();
 ...
 *   The sensor value is a 16 bits signed integer.
 */
int16_t Compass::getHeadingZ(void)
{
  int8_t return_value = 0;
  deviceCalibration();
 ...
 */
int16_t Compass::getHeading(int16_t *x, int16_t *y, int16_t *z)
{
  int8_t return_value = 0;
  deviceCalibration();
 ...
 */
int8_t Compass::writeReg(int16_t reg, uint8_t data)
{
  int8_t return_value = 0;
 ...
 */
int8_t Compass::writeData(uint8_t start, const uint8_t *pData, uint8_t size)
{
  int8_t return_value = 0;
 ...
 */
int8_t Compass::readData(uint8_t start, uint8_t *buffer, uint8_t size)
{
  int16_t i = 0;
  int8_t return_value = 0;
  Wire.beginTransmission(Device_Address);
 ...
 *   rotate the Compass over 360 degress in a stable plane that you specified to calibrate,
 ...
 */
void Compass::read_EEPROM_Buffer(void)
{
