 ...
 * MA 02110-1301, USA.
 * 
 * Derived form MeEncoderMotor.cpp Copyright (C), 2012-2016, MakeBlock available under GPL V2 or Commercial
 * 
 * 
 */
 ...
 *   slot - SLOT1 or SLOT2
 */
MeEncoderMotor::MeEncoderMotor(uint8_t addr,uint8_t slot)
{
  _slot = slot - 1;
  _slaveAddress = addr;
}
